...
<Tabs>
  <Tab title="Docker (Recommended)">
    ...
    docker run -p 3000:3000 vaur94/mcphub
    ```
...
<Tabs>
  ...
  <Tab title="Smart Routing">
    ...
    <Info>
      Smart routing requires PostgreSQL with pgvector and an LLM provider (OpenAI or compatible) API
      key.
    </Info>
  </Tab>
</Tabs>
...
Need more help? Open an issue on GitHub: https://github.com/vaur94/mcphub/issues
