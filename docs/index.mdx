---
title: MCPHub
description: 'Open-source, self-hosted MCP gateway and control plane for connecting, controlling, and operating MCP servers.'
---
...
MCPHub is an open-source, self-hosted MCP gateway and control plane that helps you connect, control, route, and operate multiple MCP servers through unified endpoints.
...
<CardGroup cols={2}>
  ...
  <Card title="Tool Result Compression" icon="file-text" href="/configuration/mcp-settings#tool-result-compression">
    Transparently reduce large text tool outputs before they reach clients
  </Card>
...
<CardGroup cols={3}>
  ...
  <Card title="Discord" icon="discord" href="https://discord.gg/2BJehJZVH5">
