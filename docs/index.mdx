---
title: MCPHub
description: 'Self-hosted MCP gateway and management platform for connecting, managing, and operating MCP servers.'
---
...
MCPHub is a self-hosted MCP gateway and management platform that helps you connect, organize, control, and operate multiple MCP servers through unified endpoints.
