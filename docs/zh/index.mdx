---
title: '欢迎使用'
description: 'MCPHub 是一个开源、自托管的 MCP 网关与控制平面，用于连接、控制和运行 MCP 服务器。'
---
...
MCPHub 是一个开源、自托管的 MCP 网关与控制平面，帮助您通过统一端点连接、控制、路由和运行多个 MCP 服务器。
...
<CardGroup cols={2}>
  ...
  <Card title="Discord 社区" icon="discord" href="https://discord.gg/2BJehJZVH5">
    与其他开发者交流，获取实时帮助
  </Card>
