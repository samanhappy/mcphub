...
**Security note**: MCP endpoints require authentication by default to avoid exposing connected tools and data. If you intentionally want public access, enable **Skip Authentication** in the security settings.
